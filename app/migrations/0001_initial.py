# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-12-02 13:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.FB_Comment')),
            ],
        ),
        migrations.CreateModel(
            name='TW_Tweet',
        ...
        migrations.AddField(
            model_name='issue',
            name='tweet',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.TW_Tweet'),
        ),
        migrations.AddField(
